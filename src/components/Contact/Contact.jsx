import {ArrowRightIcon,EnvelopeSimpleIcon,PhoneIcon,GpsIcon,InstagramLogoIcon,FacebookLogoIcon,LinkedinLogoIcon, Gps} from '@phosphor-icons/react'
import {Link} from 'react-router-dom'

function Contact(){
    return(
       <div className=" bg-nav flex flex-col items-center justify-center py-20 px-10 gap-20">
             <div className="text-rust font-fraunces text-4xl">
                <h1>Get In Touch</h1>
            </div>
            <div className="grid grid-cols-2 gap-10 w-full font-gsans text-text">
                <div className="bg-nav2 rounded-[5px] grid-cols-1  w-full flex flex-col items-start justify-center p-5 gap-10 text-md">
